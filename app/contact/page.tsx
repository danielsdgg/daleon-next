  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-7xl mx-auto px-6 py-20 lg:py-28 grid lg:grid-cols-5 gap-16 lg:gap-20">
        ...
        {/* Contact Form - More Professional */}
        <div className="lg:col-span-3 bg-white border border-gray-100 rounded-3xl shadow-xl p-10 lg:p-16">
          <h2 className="text-4xl font-bold tracking-tighter text-gray-900 mb-12">
            Start Your Project
          </h2>
          
          <form onSubmit={handleSubmit} className="space-y-10">
            <input type="hidden" name="subject" value="New Contact Form Submission - Daleon Dynamics" />
            ...
            <div>
              ...
              >
                ...
                <option value="website">Websites & Web Applications</option>
            ...
            <button
              ...
              className="w-full bg-blue-600 hover:bg-blue-700 disabled:bg-blue-400 text-white py-7 rounded-3xl font-semibold text-xl flex items-center justify-center gap-3 transition-all active:scale-[0.98] shadow-lg shadow-blue-200 hover:shadow-xl mt-4"
            >
              {isSubmitting ? (
                <>Sending Message...</>
              ) : (
            ...
            {submitStatus && (
              <div
                className={`text-center p-5 rounded-2xl text-sm font-medium ${
            ...
            <p className="text-center text-sm text-gray-500">
              We personally review every message. Expect a reply within 24 hours.
            </p>
          </form>
        </div>
